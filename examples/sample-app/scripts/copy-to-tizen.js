...
/**
 * Script para copiar el build de Angular al directorio Tizen
 */

const distDir = path.join(__dirname, '..', 'dist', 'sample-app');
const tizenDir = path.join(__dirname, '..', 'tizen', 'dist');

console.log('Copiando archivos a Tizen...');
...
// Crear directorio tizen/dist si no existe
...
try {
  ...
  console.log('✓ Archivos copiados exitosamente a tizen/dist');
} catch (error) {
